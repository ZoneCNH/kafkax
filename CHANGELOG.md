...
- 本版本不改变 `pkg/kafkax` 公共 API 形状；`Version` 元数据同步到 `v0.4.13`。
...
- 本版本不改变 `pkg/kafkax` 公共 API 形状；`Version` 元数据同步到 `v0.4.7`。
...
- 本版本不改变 `pkg/kafkax` 公共 API 形状；`Version` 元数据同步到 `v0.4.6`。
...
- 本版本不改变 `pkg/kafkax` 公共 API，仅更新版本元数据、CI 治理和文档链接。
...
- 本版本不改变 `pkg/kafkax` 公共 API，仅收紧 downstream debt 和 release Evidence 治理。
...
- 本版本不改变 `pkg/kafkax` 公共 API，仅修复 release Evidence/generator 交付口径。

## v0.4.1 - 2026-06-03

### 治理

- 对齐 release 版本口径到 `v0.4.1`，同步 `kafkax.Version`、release manifest 默认版本、preflight 命令示例和 Harness 记录。

### 兼容性

- 本版本仅更新发布治理与版本元数据，不改变 `pkg/kafkax` 公共 API 行为。
...
- 本版本不改变 `pkg/kafkax` 公共 API，仅收紧发布 Evidence 校验与文档门禁。
...
- 本版本仅包含治理和文档更新，不改变 `pkg/kafkax` 公共 API。
...
- 发布文档、Agent 运行时文档和标准文档统一到 `kafkax` 命名与 release gate 口径。
