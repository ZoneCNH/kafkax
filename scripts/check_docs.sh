...
require_text "docs/standard/layer-governance-rules.md" "kafkax"
...
require_text "contracts/layer-governance.schema.json" "kafkax layer governance registry"
...
require_text "docs/downstream-sync-policy.md" "kafkax"
...
xlib_standard_url="https://github.com/ZoneCNH/kafkax"
...
require_text "docs/standard/kafkax.md" "$xlib_standard_url"
