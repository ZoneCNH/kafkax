...
import (
	...
	"github.com/ZoneCNH/kafkax/internal/debtcheck"
)
...
func buildDockerEvidence() DockerEvidence {
	...
	toolchainImage := envDefault("DOCKER_TOOLCHAIN_IMAGE", envDefault("DOCKER_IMAGE", "kafkax-toolchain:local"))
	return DockerEvidence{
		...
		RuntimeImage:         envDefault("DOCKER_RUNTIME_IMAGE", "kafkax-goalcli-runtime:local"),
